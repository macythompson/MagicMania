class BackGround {
  ...
  //Member Variables
  int x, y;
  String locationName, dialogue1, dialogue2, dialogue3, dialogue4, dialogue5, photoName;
  PImage photo;
  boolean dialogueOne, dialogueTwo, dialogueThree, dialogueFour, dialogueFive;

  //Constructor
  BackGround(int x, int y, String locationName, String dialogue1, String dialogue2, String dialogue3, String dialogue4, String dialogue5, Boolean dialogueOne, Boolean dialogueTwo, Boolean dialogueThree, Boolean dialogueFour, Boolean dialogueFive, String photoName) {
    this.x = x;
    this.y = y;
